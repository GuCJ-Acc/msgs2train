...
def save_lf_foot_pos_imu_z_csv(output_path: Path, relative_times, foot_pos_imu_z):
    with output_path.open("w", encoding="utf-8", newline="") as csv_file:
        writer = csv.writer(csv_file)
        writer.writerow(["time", "LF_foot_pos_imu_z"])
...
def main():
    ...
    output_csv_path = save_dir / "LF" / "data_lf_foot_pos_imu_z.csv"
    ...
    save_lf_foot_pos_imu_z_csv(output_csv_path, relative_times, lf_foot_pos_imu_z)
